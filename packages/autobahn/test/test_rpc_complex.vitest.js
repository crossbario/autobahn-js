...
describe('rpc complex', function () {
   test('complex results with args and kwargs', function () {
         ...
         connection.onopen = function (session) {
            ...
            autobahn.when.all(pl1).then(
               function () {
                  ...
                  d = d.then(function () {
                     return session
                        .call('com.myapp.split_name', ['Homer Simpson'])
                        .then(function (res) {
                  ...
                  for (var i = 0; i < params.length; ++i) {
                     (function (i, args, kwargs) {
                        d = d.then(function () {
                           return session
                              .call('com.myapp.echo_complex', args, kwargs)
                              .then(function (res) {
