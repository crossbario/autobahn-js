...
describe('rpc arguments', function () {
   test('various argument signatures', function () {
         ...
         connection.onopen = function (session) {
            ...
            autobahn.when.all(pl1).then(
               function () {
                  ...
                  pl2.push(
                     session.call('com.arguments.ping').then(function () {
                        test.log('Pinged');
                     })
                  );

                  pl2.push(
                     session.call('com.arguments.add2', [2, 3]).then(function (res) {
                        test.log('Add2:', res);
                     })
                  );

                  pl2.push(
                     session.call('com.arguments.stars').then(function (res) {
                  ...
                  pl2.push(
                     session
                        .call('com.arguments.stars', [], { nick: 'Homer' })
                        .then(function (res) {
                  ...
                  pl2.push(
                     session.call('com.arguments.stars', [], { stars: 5 }).then(function (res) {
                  ...
                  pl2.push(
                     session
                        .call('com.arguments.stars', [], { nick: 'Homer', stars: 5 })
                        .then(function (res) {
                  ...
                  pl2.push(
                     session.call('com.arguments.orders', ['coffee']).then(function (res) {
                        test.log('Orders 1:', res);
                     })
                  );

                  pl2.push(
                     session.call('com.arguments.orders', ['coffee'], { limit: 10 }).then(
                        function (res) {
                  ...
                  pl2.push(
                     session.call('com.arguments.arglen').then(function (res) {
                        test.log('Arglen 1', res);
                     })
                  );

                  pl2.push(
                     session.call('com.arguments.arglen', [1, 2, 3]).then(function (res) {
                  ...
                  pl2.push(
                     session
                        .call('com.arguments.arglen', [], { a: 1, b: 2, c: 3 })
                        .then(function (res) {
                  ...
                  pl2.push(
                     session
                        .call('com.arguments.arglen', [1, 2, 3], { a: 1, b: 2, c: 3 })
                        .then(function (res) {
