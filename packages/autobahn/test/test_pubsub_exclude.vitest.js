...
describe('pubsub exclude', function () {
   test('exclude option on publication', function () {
         ...
         autobahn.when.all(dl).then(
            function (res) {
               ...
               function case1() {
                  ...
                  autobahn.when
                     .all([session2Finished.promise, session3Finished.promise])
                     .then(function () {
                        clearInterval(t1);
               ...
               function case3() {
                  ...
                  var t3 = setInterval(function () {
                     session1.publish(
                        ...
                        [counter],
                        {},
                        { exclude: [session2.id, session3.id] }
                     );
                     counter += 1;
                  ...
                  autobahn.when
                     ...
                     .then(function () {
                        ...
                        testcase.ok(
                           received2 === 1 && received3 === 1,
                           'Case 3: Both clients received final event'
                        );
