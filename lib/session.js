      ...
      if (subscription in self._subscriptions) {
         ...
         for (var i = 0; i < subs.length; ++i) {
            try {
               ...
               console.error("Exception raised in event handler", e);
            }
         }
...
Session.prototype.join = function (realm, authmethods, authid, options) {
   ...
   var details = JSON.parse(JSON.stringify(options ? options : {}));
