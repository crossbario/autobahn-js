...
Connection.prototype._autoreconnect_advance = function () {
   ...
   var res;
   if (self._retry && (self._retry_count <= self._max_retries || self._max_retries < 0)) {
      res = {
...
Connection.prototype.open = function () {
   ...
   function retry () {
      ...
      self._transport.onopen = function () {
         ...
         // start WAMP session
         self._session.join(self._options.realm, self._options.authmethods, self._options.authid, self._options.joinOptions);
      };
