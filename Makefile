...
test_basic_async:
	cd packages/autobahn && AUTOBAHN_TRACE=test_basic_async.json nodeunit test/test_basic_async.js

test_basic_sync:
	cd packages/autobahn && AUTOBAHN_TRACE=test_basic_sync.json nodeunit test/test_basic_sync.js

test_binary:
	cd packages/autobahn && AUTOBAHN_TRACE=test_binary.json nodeunit test/test_binary.js

test_connect:
	cd packages/autobahn && AUTOBAHN_TRACE=test_connect.json nodeunit test/test_connect.js

test_error_handling:
	cd packages/autobahn && AUTOBAHN_TRACE=test_error_handling.json nodeunit test/test_error_handling.js

test_pubsub_basic:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_basic.json nodeunit test/test_pubsub_basic.js

test_pubsub_complex:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_complex.json nodeunit test/test_pubsub_complex.js

test_pubsub_eligible:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_multiple_matchintest_pubsub_eligibleg_subs.json nodeunit test/test_pubsub_eligible.js

test_pubsub_exclude:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_exclude.json nodeunit test/test_pubsub_exclude.js

test_pubsub_excludeme:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_excludeme.json nodeunit test/test_pubsub_excludeme.js

test_pubsub_options:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_options.json nodeunit test/test_pubsub_options.js

test_pubsub_prefix_sub:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_prefix_sub.json nodeunit test/test_pubsub_prefix_sub.js

test_pubsub_wildcard_sub:
	cd packages/autobahn && AUTOBAHN_TRACE=test_pubsub_wildcard_sub.json nodeunit test/test_pubsub_wildcard_sub.js

test_rawsocket_protocol:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rawsocket_protocol.json nodeunit test/test_rawsocket_protocol.js

test_rawsocket_transport:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rawsocket_transport.json nodeunit test/test_rawsocket_transport.js

test_rpc_arguments:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_arguments.json nodeunit test/test_rpc_arguments.js

test_rpc_complex:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_complex.json nodeunit test/test_rpc_complex.js

test_rpc_error:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_error.json nodeunit test/test_rpc_error.js

test_rpc_options:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_options.json nodeunit test/test_rpc_options.js

test_rpc_progress:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_progress.json nodeunit test/test_rpc_progress.js

test_rpc_request_id_sequence:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_request_id_sequence.json nodeunit test/test_rpc_request_id_sequence.js

test_rpc_routing:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_routing.json nodeunit test/test_rpc_routing.js

test_rpc_slowsquare:
	cd packages/autobahn && AUTOBAHN_TRACE=test_rpc_slowsquare.json nodeunit test/test_rpc_slowsquare.js

test_sealedbox:
	cd packages/autobahn && AUTOBAHN_TRACE=test_sealedbox.json nodeunit test/test_sealedbox.js

test_serialization_cbor:
	cd packages/autobahn && AUTOBAHN_TRACE=test_serialization_cbor.json nodeunit test/test_serialization_cbor.js

test_serialization_json:
	cd packages/autobahn && AUTOBAHN_TRACE=test_serialization_json.json nodeunit test/test_serialization_json.js

test_serialization_msgpack:
	cd packages/autobahn && AUTOBAHN_TRACE=test_serialization_json.json nodeunit test/test_serialization_msgpack.js


test: test_basic_async test_basic_sync test_binary test_connect test_error_handling test_pubsub_basic test_pubsub_complex test_pubsub_eligible test_pubsub_exclude test_pubsub_excludeme test_pubsub_options test_pubsub_prefix_sub test_pubsub_wildcard_sub test_rawsocket_protocol test_rawsocket_transport test_rpc_arguments test_rpc_complex test_rpc_error test_rpc_options test_rpc_progress test_rpc_request_id_sequence test_rpc_routing test_rpc_slowsquare test_sealedbox test_serialization_cbor test_serialization_json test_serialization_msgpack
